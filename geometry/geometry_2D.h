...
public:
    ...
    Polygon getExcribedPolygon( double delta ) const ;
} ;
...
public:
    ...
    double getMajorRadius() const {
        return majorAxis.norm() ;
    } ;

    /** \brief Get the norm of the minor radius */
    double getMinorRadius() const {
        return minorAxis.norm() ;
    } ;

    void setMajorAxis(const Point & p) {
        majorAxis = p ;
    }

    void setMinorAxis(const Point & p) {
        minorAxis = p ;
    }
    ...
    double getExcentricity() const {
        return  sqrt(1. - ((getMinorRadius() * getMinorRadius()) / (getMajorRadius() * getMajorRadius()))) ;
    } ;
    ...
    double getParameter() const {
        return getMajorRadius() * (1. - getExcentricity()*getExcentricity()) ;
    } ;
     ...
     * @return the angle (in radians)
     */
    double getMinorAxisAngle() const {
        return minorAxis.angle() ;
    } ;
     ...
     */
    const Point & getMinorAxis() const {
        return minorAxis ;
    } ;
     ...
     * @return the minor radius as a normalized unit-vector.
     */
    const Point & getMajorAxis() const {
        return majorAxis ;
    } ;
