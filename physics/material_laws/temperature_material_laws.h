...
struct TemperatureDependentRadiationInducedExpansionMaterialLaw : public ExternalMaterialLaw
{
    TemperatureDependentRadiationInducedExpansionMaterialLaw(std::string args = std::string(), char sep = ',') : ExternalMaterialLaw(args, sep) { }
    virtual ~TemperatureDependentRadiationInducedExpansionMaterialLaw() { } ;
