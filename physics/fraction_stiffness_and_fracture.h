...
#ifndef _FRACT_STIFFNESS_AND_FRACTURE_H
#define _FRACT_STIFFNESS_AND_FRACTURE_H
...
namespace Amie
{
	...
	*/
	struct FractionStiffnessAndFracture : public LinearForm
	{
...
// 		IsotropicLinearDamage dfunc ;
		...
		*/
		FractionStiffnessAndFracture(const Matrix & rig, const Matrix & rig0, double phi, FractureCriterion * c, double eps = 0.002)  ;
		void setNeighbourhoodRadius(double d ) ;

		virtual ~FractionStiffnessAndFracture();
