...
*/
class SpaceTimeRateBasedIsotropicLinearDamage final: public DamageModel
{
public:
...
public:
     ...
     */
    SpaceTimeRateBasedIsotropicLinearDamage(double cutoff = 0.6) ;

    virtual ~SpaceTimeRateBasedIsotropicLinearDamage();
