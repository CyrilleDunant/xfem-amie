...
{
	CommandLineParser parser("Builds a sample with a regular polygonal inclusion masking an ellipsoidal inclusion") ;
	...
	std::string name = "../examples/mesh/mesh_polygon_ellipse_mask_" ;
	if(renew)
		name += "base" ;
	else
		name += "current" ;
