...
{
	CommandLineParser parser("Builds a sample with a single ellipsoidal inclusion that intersects the sample") ;
	...
	std::string name = "../examples/mesh/mesh_ellipse_sample_intersection_" ;
	if(renew)
		name += "base" ;
	else
		name += "current" ;
