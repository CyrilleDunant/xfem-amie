...
{
	CommandLineParser parser("Builds a sample with a single convex polygonal inclusion in the center of the sample") ;
	...
	std::string name = "../examples/mesh/mesh_polygon_convex_" ;
	if(renew)
		name += "base" ;
	else
		name += "current" ;
