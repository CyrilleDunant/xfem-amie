...
{
	CommandLineParser parser("Builds a sample with a circular inclusion intersecting an ellipsoidal inclusion") ;
	...
	std::string name = "../examples/mesh/mesh_circle_ellipse_intersection_" ;
	if(renew)
		name += "base" ;
	else
		name += "current" ;
