...
{
	CommandLineParser parser("Builds a sample with two intersecting ellipsoidal inclusions") ;
	...
	EllipsoidalInclusion inc(Point(0.005,0.005), Point(0.012,0),Point(0,0.012*0.7)) ;
	inc.setBehaviour(new Stiffness(20e9, 0.2) ) ;

	EllipsoidalInclusion inc2(Point(-0.005,-0.005), Point(0.012*0.7,0),Point(0,0.012))  ;
	...
	std::string name = "../examples/mesh/mesh_ellipse_ellipse_intersection_" ;
	if(renew)
		name += "base" ;
	else
		name += "current" ;
