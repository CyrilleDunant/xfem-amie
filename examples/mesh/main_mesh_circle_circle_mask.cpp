...
{
	CommandLineParser parser("Builds a sample with one circular inclusion masking another") ;
	...
	Inclusion inc2(0.01,0.005,-0.005) ;
	...
	std::string name = "../examples/mesh/mesh_circle_circle_mask_" ;
	if(renew)
		name += "base" ;
	else
		name += "current" ;
