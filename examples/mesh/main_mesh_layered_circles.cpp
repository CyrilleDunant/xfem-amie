...
{
	CommandLineParser parser("Builds a sample with two concentric circular inclusions in the center of the sample") ;
	...
	std::string name = "../examples/mesh/mesh_layered_circles_" ;
	if(renew)
		name += "base" ;
	else
		name += "current" ;
