...
#include "../physics/geometryBasedEffects/linearcontactforce.h"
#include "../physics/geometryBasedEffects/linearcontactdisplacement.h"
...
Rectangle rect(10, 10, 10.*.5+0.035*.5+0.00005, 10.*.5+0.00005) ;
