...
//	F.setOrder(LINEAR) ;
	...
	box.setBehaviour( new Viscoelasticity/*AndFracture*/(GENERALIZED_KELVIN_VOIGT, c, c*0.3, c*0.3*10/*, new SpaceTimeNonLocalMohrCoulomb(0.001, -0.008, 15e9), new SpaceTimeFiberBasedIsotropicLinearDamage() )*/ ) ) ;
