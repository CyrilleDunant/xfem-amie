...
int main(int argc, char *argv[])
{
  ...
  std::vector<Inclusion *> incs = PSDGenerator::get2DInclusions(maxRadius, maxRadius*maxRadius*M_PI*40., new GranuloFromCumulativePSD(argv[1], CUMULATIVE_ABSOLUTE_REVERSE, 1000., maxRadius, minRadius), PSDEndCriteria(.1, 0., 50000) ) ;
  double bulk = 13.9 ;
  double shear = 8.75 ;
