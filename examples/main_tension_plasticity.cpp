...
//         Matrix C = BiphasicSelfConsistentComposite(Phase(paste,0.499, SPACE_THREE_DIMENSIONAL, t, a, b, c) , Phase(agg, 0.501, SPACE_THREE_DIMENSIONAL, t, a, b, c), hint).getBehaviour()->getTensor(Point()) ;
