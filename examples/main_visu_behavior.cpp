...
///////////////////////////////////////////////////
    ...
    double mradius = 0.7 ;
    StiffnessAndFracture * paste = new StiffnessAndFracture(E_kv, new NonLocalDeviatoricVonMises(2.0e6, mradius), new PrandtlGrauertPlasticStrain()) ;
...
///////////////////////////////////////////////////
    ...
    while( F.getAverageField( TOTAL_STRAIN_FIELD )[1] < 0.0003 )
    {
