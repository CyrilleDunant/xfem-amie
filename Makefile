...
SOURCE_PHYSICS = physics/physics.cpp physics/physics_base.cpp physics/stiffness.cpp physics/diffusion.cpp physics/stiffness_with_imposed_deformation.cpp physics/weibull_distributed_stiffness.cpp physics/lineardamage.cpp physics/stiffness_and_fracture.cpp  physics/void_form.cpp physics/fracturecriterion.cpp physics/mohrcoulomb.cpp physics/vonmises.cpp physics/maxstrain.cpp physics/dual_behaviour.cpp physics/radialstiffnessgradient.cpp physics/linearstiffnessgradient.cpp physics/ruptureenergy.cpp physics/kelvinvoight.cpp physics/isotropiclineardamage.cpp
OBJECTS_PHYSICS = physics/physics.o physics/physics_base.o physics/stiffness.o physics/stiffness_and_fracture.o  physics/void_form.o physics/weibull_distributed_stiffness.o physics/stiffness_with_imposed_deformation.o physics/lineardamage.o physics/fracturecriterion.o physics/mohrcoulomb.o physics/vonmises.o physics/maxstrain.o physics/diffusion.o physics/dual_behaviour.o physics/radialstiffnessgradient.o  physics/linearstiffnessgradient.o physics/ruptureenergy.o physics/kelvinvoight.o physics/isotropiclineardamage.o
