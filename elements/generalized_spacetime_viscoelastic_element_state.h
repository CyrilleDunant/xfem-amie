...
public:
    ...
    virtual double getAverageField( FieldType f, Vector & ret, VirtualMachine * vm = nullptr, int i = 0, double t = 0, const std::vector< double > & weights = std::vector<double>())final ;

    virtual double getAverageField( FieldType f, FieldType f_, Vector & ret, Vector & ret_, VirtualMachine * vm = nullptr, int dummy= 0, double t = 0, const std::vector< double > & weights = std::vector<double>()) final ;
