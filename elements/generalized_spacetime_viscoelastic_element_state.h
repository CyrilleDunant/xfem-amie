...
public:
	...
	virtual void getFieldAtNodes( FieldType f, Vector & ret, int i = 0, bool recompute = false) ;
	...
	virtual void getFieldAtNodes( FieldType f1, FieldType f2, Vector & ret1, Vector & ret2, int i = 0, int j = 0, bool recompute = false) ;
