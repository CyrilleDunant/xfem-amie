...
struct Enum
{
    ...
    static FieldType getFieldType(std::string type, bool * ok = 0)
    {
        ...
        if( type == "GENERALIZED_VISCOELASTIC_STRAIN_FIELD") { return GENERALIZED_VISCOELASTIC_TOTAL_STRAIN_FIELD ; }
        ...
        if( type == "GENERALIZED_VISCOELASTIC_PRINCIPAL_STRAIN_FIELD") { return GENERALIZED_VISCOELASTIC_PRINCIPAL_TOTAL_STRAIN_FIELD ; }
        ...
        if( type == "GENERALIZED_VISCOELASTIC_NON_ENRICHED_STRAIN_FIELD") { return GENERALIZED_VISCOELASTIC_NON_ENRICHED_TOTAL_STRAIN_FIELD ; }
    ...
    static std::string fromFieldType(FieldType value)
    {
        switch(value)
        {
            ...
            case GENERALIZED_VISCOELASTIC_TOTAL_STRAIN_FIELD: return "GENERALIZED_VISCOELASTIC_STRAIN_FIELD" ;
            ...
            case GENERALIZED_VISCOELASTIC_MECHANICAL_STRAIN_FIELD : return "GENERALIZED_VISCOELASTIC_MECHANICAL_STRAIN_FIELD" ;
            case GENERALIZED_VISCOELASTIC_REAL_STRESS_FIELD: return "GENERALIZED_VISCOELASTIC_REAL_STRESS_FIELD" ;
            case GENERALIZED_VISCOELASTIC_PRINCIPAL_TOTAL_STRAIN_FIELD: return "GENERALIZED_VISCOELASTIC_PRINCIPAL_STRAIN_FIELD" ;
            ...
            case GENERALIZED_VISCOELASTIC_NON_ENRICHED_TOTAL_STRAIN_FIELD: return "GENERALIZED_VISCOELASTIC_NON_ENRICHED_STRAIN_FIELD" ;
