...
TimeDependentEnrichmentInclusion::TimeDependentEnrichmentInclusion(Feature * father, Function & r, double x, double y) : EnrichmentInclusion( father, VirtualMachine().eval(r, Point(0,0,0,0)),x,y), radius_t(r)
{
  
}

TimeDependentEnrichmentInclusion::TimeDependentEnrichmentInclusion( Function & r, double x, double y) : EnrichmentInclusion( VirtualMachine().eval(r, Point(0,0,0,0)),x,y), radius_t(r)
{
