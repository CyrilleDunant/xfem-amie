...
{
    double teststate = (condition == ULTIMATE_STRESS) ? (ft->getAverageField(REAL_STRESS_FIELD, 1., -1))[axisIndex] : (ft->getAverageField(MECHANICAL_STRAIN_FIELD, 1., -1))[axisIndex];
    if(!cycleStarted)
    {
