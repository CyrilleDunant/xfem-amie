...
public:
    ...
    virtual void apply(Assembly * a, Mesh<DelaunayTriangle, DelaunayTreeItem> * t, VirtualMachine * vm);
    
    virtual void apply(Assembly * a, Mesh<DelaunayTetrahedron, DelaunayTreeItem3D> * t, VirtualMachine * vm);
