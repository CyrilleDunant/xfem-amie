...
namespace Amie
{
    ...
    protected:
        ...
        FeatureTree * ftree ;
    public:
            GelManager(FeatureTree * ftree, double zonedensity, const std::vector<Feature *> & aggregates,double reactiveFraction = 0.1, double deltaRadius = -1, double initalRadius = 0.000125) ;
