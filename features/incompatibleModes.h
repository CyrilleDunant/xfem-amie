...
//
//
#ifndef __INCOMPATIBLE_MODES_H__
#define __INCOMPATIBLE_MODES_H__
 ...
 */
class IncompatibleModes :  public EnrichmentFeature, public Triangle
{
protected:
    bool updated ;
...
public:
    ...
    {
        std::cout << "incompatible modes for large deformations" << std::endl ;
    }
